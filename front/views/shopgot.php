...
<html lang="en">
    <head>
        ...
        <div class="col-lg-8 align-self-baseline">
                       ...
                       <a class="btn btn-primary btn-xl js-scroll-trigger" href="orderg.php">LOWEST PRICES TO THE HIGHEST </a>
                       <a class="btn btn-primary btn-xl js-scroll-trigger" href="orderdescg.php">HIGHEST PRICES TO THE LOWEST </a>
                   </div>
<thead>
...
$result=$mysqli->query("select * from productss where category='got customized'");
