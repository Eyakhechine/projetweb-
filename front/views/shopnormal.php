...
<html lang="en">
  ...
  <!-- search-->
        ...
        <div class="col-lg-8 align-self-baseline">
                        ...
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="ordern.php">LOWEST PRICES TO THE HIGHEST </a>
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="orderdescn.php">HIGHEST PRICES TO THE LOWEST </a>
                    </div>
...
$result=$mysqli->query("select * from productss where category='normal'");
