...
$reviews_list = $reviews_obj->reviews_list();
?>
...
if ($reviews_list->num_rows > 0) {
  while ($row = $reviews_list->fetch_assoc()) {
     ?>
             <tr>
                ...
                <td class="text-right">
                    <a  href="<?php echo '../model/delete-review-info.php?id=' . $row["review_id"] ?>" class="button button-red">Delete</a>  
                    
                    <a href="<?php echo '../model/read-review-info.php?id=' . $row["review_id"] ?>" class="button button-green">View</a>
                </td>
            </tr>
    <?php
    }
